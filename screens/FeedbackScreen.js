...
function FeedbackScreen({ navigation }) {
  ...
  async function submitFeedbackHandler(enteredText) {
    ...
    <View style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.title}>Leave a feedback</Text>
          <View style={styles.placeholder}></View>
        </View>
      
        <Text style={styles.comment}>We greatly value your input and involvement, and we would appreciate hearing how we can further improve for your benefit.</Text>
        ...
        <View style={styles.submitFormContainer}>
          <Pressable onPress={submitFeedbackHandler.bind(this, enteredText)} style={({pressed}) => pressed && flag && styles.pressed}>
